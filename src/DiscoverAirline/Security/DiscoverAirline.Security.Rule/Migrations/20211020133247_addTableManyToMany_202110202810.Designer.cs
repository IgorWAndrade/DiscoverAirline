...
namespace DiscoverAirline.Security.Rule.Migrations
{
    ...
    [Migration("20211020133247_addTableManyToMany_202110202810")]
    partial class addTableManyToMany_202110202810
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActionAuthorization", b =>
                {
                    ...
                    b.Property<int>("AuthorizationsRoleId")
                        .HasColumnType("int");

                    b.HasKey("ActionsId", "AuthorizationsRoleId");

                    b.HasIndex("AuthorizationsRoleId");
            ...
            modelBuilder.Entity("AuthorizationController", b =>
                {
                    b.Property<int>("AuthorizationsRoleId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AuthorizationsRoleId", "ControllersId");

                    b.HasIndex("ControllersId");

                    b.ToTable("AuthorizationController");
                });

            modelBuilder.Entity("AuthorizationService", b =>
                {
                    b.Property<int>("AuthorizationsRoleId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AuthorizationsRoleId", "ServicesId");
            ...
            modelBuilder.Entity("ControllerService", b =>
                {
                    b.Property<int>("ServicesId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ServicesId", "ServicesId1");

                    b.HasIndex("ServicesId1");

                    b.ToTable("ControllerService");
                });
            ...
            modelBuilder.Entity("ActionAuthorization", b =>
                {
                    ...
                    b.HasOne("DiscoverAirline.Security.Domain.Entities.Authorization", null)
                        .WithMany()
                        .HasForeignKey("AuthorizationsRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AuthorizationService", b =>
                {
                    ...
                    b.HasOne("DiscoverAirline.Security.Domain.Entities.Service", null)
                        .WithMany()
