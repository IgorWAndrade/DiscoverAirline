...
namespace DiscoverAirline.Security.Rule.Migrations
{
    ...
    [Migration("20211020164505_modifiedTableAuthorizations_pkRoleIdServiceIdControllerId_202110204413")]
    partial class modifiedTableAuthorizations_pkRoleIdServiceIdControllerId_202110204413
    {
            ...
            modelBuilder.Entity("ActionAuthorization", b =>
                {
                    ...
                    b.Property<int>("AuthorizationsServiceId")
                        .HasColumnType("int");

                    b.Property<int>("AuthorizationsControllerId")
                        .HasColumnType("int");

                    b.HasKey("ActionsId", "AuthorizationsRoleId", "AuthorizationsServiceId", "AuthorizationsControllerId");

                    b.HasIndex("AuthorizationsRoleId", "AuthorizationsServiceId", "AuthorizationsControllerId");
            ...
            modelBuilder.Entity("DiscoverAirline.Security.Domain.Entities.Authorization", b =>
                {
                    ...
                    b.HasKey("RoleId", "ServiceId", "ControllerId");
            ...
            modelBuilder.Entity("ActionAuthorization", b =>
                {
                    ...
                    b.HasOne("DiscoverAirline.Security.Domain.Entities.Authorization", null)
                        .WithMany()
                        .HasForeignKey("AuthorizationsRoleId", "AuthorizationsServiceId", "AuthorizationsControllerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
