...
namespace DiscoverAirline.Security.API.Controllers
{
    public class AccessController : CoreController
    {
        ...
        [HttpDelete("Access")]
        [AuthorizationCustom("Security", "AccessController", "Delete")]
